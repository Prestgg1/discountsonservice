  ...
  const users = [
    {
      ...
      social:[
        <a href="https://www.instagram.com/sebuhii313/"> <FaInstagram className="hover:text-primary opacity-0 invisible"  /></a>,
        <a href="https://www.youtube.com/channel/UC21kkrj6JNagvxPuDBsPM7Q"> <FaYoutube className="hover:text-primary opacity-0 invisible" /></a>,
        <a href="https://x.com/Prestgg1"> <FaTwitter className="hover:text-primary opacity-0 invisible"  /></a>
      ]
    },
    {
      id:2,
      ...
      social:[
        <a href="https://www.instagram.com/sebuhii313/"> <FaInstagram className="hover:text-primary opacity-0 invisible"  /></a>,
        <a href=""> <FaFacebook className="hover:text-primary opacity-0 invisible" /></a>,
        <a href=""> <FaTwitter className="hover:text-primary opacity-0 invisible"  /></a>
      ]
    ...
    },
    {
      ...
      social:[
        <a href="https://www.instagram.com/ka.m7l"> <FaInstagram className="hover:text-primary opacity-0 invisible"  /></a>,
        <a href=""> <FaFacebook className="hover:text-primary opacity-0 invisible" /></a>,
        <a href=""> <FaTwitter className="hover:text-primary opacity-0 invisible"  /></a>
      ]
    }
          ...
          <div key={i} className="card   card-compact bg-base-100 mx-2 md:mx-0 md:max-w-60 shadow-xl">
            <figure className="team h-full   relative">
              ...
              <div className="absolute justify-center flex items-center gap-4 [&_svg]:text-[#fff] [&_svg]:text-3xl [&_svg]:cursor-pointer opacity-0 [&_svg]:hover:visible [&_svg]:hover:opacity-100 [&_svg]:duration-300   w-11/12 h-5/6 rounded-xl bg-slate-500">
               ...
               {users[i].social?.map((_,key)=>{
                 return users[i].social[key];
               })}
              </div>
            </figure>
            <div className="card-body  basis-2/5 flex flex-col justify-center items-center text-center">
              <h2 className="card-title"> {users[i].fullname} </h2>
              <p className="text-wrap"> {users[i].descriptions} </p>
            </div>
          </div>
        ))}
    </section>
